...
async function fetchFromPokeAPI() {
  ...
  console.log("Fetching data from PokeAPI (GraphQL)... this might take a few seconds.");
...
async function seedPokemon() {
  ...
  console.log(`Found ${formattedPokemon.length} Pokémon entries (including all forms).`);
